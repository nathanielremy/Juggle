...
class ReviewCell: UICollectionViewCell {
    ...
    fileprivate func setupViews() {
        ...
        addSubview(starView)
        starView.anchor(top: topAnchor, left: profileImageView.rightAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 110, height: 25)
